...
std::string getLCA(Commit current_commit,Commit other_commit);//得到最近祖先
void remoteCommit(Commit commit,std::string pathToRemote,std::string pathToCurrent);//把本地提交放到远程
#endif // REPOSITORY_H
